            ...
            <AppBar position="static" elevation={2}>
                <Toolbar>
...

                    {
                        isAuthenticated
                            ? <>
                                <Button component={Link} to={routes.profile.path} color="inherit" style={isActiveRoute(routes.profile.path)}>Profile</Button>

                                <Button color="inherit" onClick={onClickLogout}>Logout</Button>
                            </>
                            : <>
                                <Button component={Link} to={routes.login.path} color="inherit" style={isActiveRoute(routes.login.path)}>Login</Button>

                                <Button component={Link} to={routes.signup.path} color="inherit" style={isActiveRoute(routes.signup.path)}>Signup</Button>
                            </>
                    }
                </Toolbar>
            </AppBar>
                    ...
                    <Toolbar>
                        {
                            details.role === params.user.roles.admin.key
                                ...
                                : <>
                                    <Button component={Link} to={routes.dashboard.path} color="inherit" style={isActiveRoute(routes.dashboard.path, 'secondary')}>Dashboard</Button>
